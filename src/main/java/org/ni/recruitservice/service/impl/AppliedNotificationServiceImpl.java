 ...
 */
public class AppliedNotificationServiceImpl implements NotificationService {
    private static Logger log = LoggerFactory.getLogger(AppliedNotificationServiceImpl.class);
    private static NotificationService singleton = null;

    public synchronized static NotificationService getInstance() {
        if (singleton == null) singleton = new AppliedNotificationServiceImpl();
        return singleton;
    }
